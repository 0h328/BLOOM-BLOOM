...
function Storecard() {
  return(
    <Box sx={{width:420,height:242,mt:3,backgroundColor: "#FFE0E0"}}>
      ...
      <Box sx={{width:420,display:'flex'}}>
        <Button sx={{width:156,height:36,mx:"auto", backgroundColor:'#FFFFFF',color: "#000000",fontFamily: "JuliusSansOne",mt:4}}> 주문하기 </Button>
      </Box>
    </Box>
  );
};
